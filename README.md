...
<h1 align="center">🦋 Hola, soy Stefhany 🦋</h1>
<p align="center">✨ <i>Aesthetic Profile</i> ✨</p>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="40%" valign="top" style="padding-right: 15px;">
      ...
      <h3>✨ SOBRE MÍ</h3>
      ▪️ 📚 Aprendiendo programación<br>
      ▪️ 🎨 Interesada en diseño y tecnología<br>
      ▪️ 🚀 Creando cosas nuevas

      <br><br>

      <h3>🔷 HAZLO YAAA (Metas)</h3>
      - [ ] Dejar de procrastinar 💻<br>
      - [ ] Tener una rutina de ejercicios 🏋️‍♀️<br>
      - [ ] Ganar mi propio dinero 💸<br>
      - [ ] No dejar de lado el voley 🏐<br>
      - [ ] SER POSITIVA ✨<br>
      - [ ] Saber inglés 🇬🇧
    ...
    <td width="60%" valign="top" style="padding-left: 15px;">
      ...
      <h3>📝 NOTAS:</h3>
      <ul>
        <li>Siempre lleva agüita 💧</li>
        <li>Si estás preocupada, no te preocupes.</li>
        <li>Comprar comida para mí (opcional) 🍟</li>
        <li><b>CONSEJO DEL DÍA:</b> ya nd pq es de noche 🌃</li>
        <li>Celosa y llorona, pero jamás infiel ✨</li>
      </ul>
